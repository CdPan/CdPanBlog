...
// 查询分类表
    @GetMapping("/types")
    public String list(Model model,@RequestParam(defaultValue = "1",value = "pageNum") Integer pageNume){
        //按照排序字段 倒叙 排序
        String orderBy = "id desc";
        PageHelper.startPage(pageNume,10,orderBy);
        //获取分类表
